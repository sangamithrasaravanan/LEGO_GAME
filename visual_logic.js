 ...
 * Tue Apr 16 2024 16:36:48 GMT+0530 (India Standard Time)
...
var dictred, cloneblack, cloneyellow, cloneblue, clonered, dictblack, dictyellow, dictblue;
...
function drag3() {
  registerOnClick(['ALL_OBJECTS'], false, false, [0,1,2], function() {
    registerOnDrag(cloneyellow, false, [0,1,2], function() {}, function() {
      dragMove(cloneyellow, 'XYZ', ']2Sn:Z0E2zRrZJstCP5N', 'w#(b8k6a!W}QFKdpF.11');
    }, function() {}, 'w#(b8k6a!W}QFKdpF.11');
    objConstraintAddLimit('myConst1', cloneyellow, 'POS_Z', 1.70602, 12, '', 0, 'LIMITDIST_ONSURFACE');
  }, function() {});
}
...
function drag1() {
  registerOnClick(['ALL_OBJECTS'], false, false, [0,1,2], function() {
    registerOnDrag(cloneblack, false, [0,1,2], function() {}, function() {
      dragMove(cloneblack, 'XYZ', '{RTm,CT_)?S]U_$22C8#', 'apwsa`cfcne:{L+-#Z/o');
    }, function() {}, 'apwsa`cfcne:{L+-#Z/o');
    objConstraintAddLimit('myConst1', cloneblack, 'POS_Z', 1.70602, 12, '', 0, 'LIMITDIST_ONSURFACE');
  }, function() {});
}
...
function drag4() {
  registerOnClick(['ALL_OBJECTS'], false, false, [0,1,2], function() {
    registerOnDrag(clonered, false, [0,1,2], function() {}, function() {
      dragMove(clonered, 'XYZ', 'UuV8=|lN(Ha~wo{5CcA6', '_GUFs(%?qX4I$Ay8w}DG');
    }, function() {}, '_GUFs(%?qX4I$Ay8w}DG');
...
function drag2() {
  registerOnClick(['ALL_OBJECTS'], false, false, [0,1,2], function() {
    registerOnDrag(cloneblue, false, [0,1,2], function() {}, function() {
      dragMove(cloneblue, 'XYZ', '^8+HVnO[X!HlI!esI#/]', 'pD,hdJ}S25|rK/l,o+Dx');
    }, function() {}, 'pD,hdJ}S25|rK/l,o+Dx');
    objConstraintAddLimit('myConst1', cloneblue, 'POS_Z', 1.70602, 12, '', 0, 'LIMITDIST_ONSURFACE');
  }, function() {});
}
...
addHTMLElement('button', 'Black', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('position', 'static', 'Black', false);
setHTMLElemStyle('backgroundColor', 'Black', 'Black', false);
setHTMLElemStyle('height', '60px', 'Black', false);
setHTMLElemStyle('width', '60px', 'Black', false);
...
registerOnDrag('Cylinder.021', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.021', 'XYZ', 'iT9|OC4M)Mf#~,`a%kK/', '4ZowuAAvQ.S1(@N?vwOB');
}, function() {}, '4ZowuAAvQ.S1(@N?vwOB');
...
eventHTMLElem('click', 'Blue', false, function(event) {
  changeVis('Cylinder.005', true);
});
registerOnDrag('Cylinder.005', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.005', 'XYZ', '%?YL|qA6UfQ^[zGM2_8,', 'K:X`)#%PL-46$1QZC/qg');
}, function() {}, 'K:X`)#%PL-46$1QZC/qg');
...
registerOnDrag('Cylinder.006', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.006', 'XYZ', 'x%m{r31,OpBk_T*cZ4y7', 'UD%dgFR,*Sgi]{OHsRk*');
}, function() {}, 'UD%dgFR,*Sgi]{OHsRk*');
...
registerOnDrag('Cylinder.001', false, [0,1,2], function() {}, function() {
  dragMove('Cylinder.001', 'XYZ', 'tzuVm(mRE![@1ENPj;8!', 'suy`;P|sW[p~ZTo7HXfz');
}, function() {}, 'suy`;P|sW[p~ZTo7HXfz');

eventHTMLElem('dblclick', 'Black', false, function(event) {
  cloneblack = cloneObject('Cylinder.021');
  changeVis(cloneblack, true);
  drag1();
});
eventHTMLElem('dblclick', 'yellow', false, function(event) {
  cloneyellow = cloneObject('Cylinder.006');
  changeVis(cloneyellow, true);
  drag3();
});
eventHTMLElem('dblclick', 'Blue', false, function(event) {
  cloneblue = cloneObject('Cylinder.005');
  changeVis(cloneblue, true);
  drag2();
});
eventHTMLElem('dblclick', 'Red', false, function(event) {
  clonered = cloneObject('Cylinder.001');
...
dictblack = {};
dictSet(dictblack, 'x2', getObjTransform(dictblack, false, 'position', 'x'));
dictSet(dictblack, 'y2', getObjTransform(dictblack, false, 'position', 'y'));
dictSet(dictblack, 'z2', getObjTransform(dictblack, false, 'position', 'z'));
dictyellow = {};
dictSet(dictyellow, 'x3', getObjTransform(dictyellow, false, 'position', 'x'));
dictSet(dictyellow, 'y3', getObjTransform(dictyellow, false, 'position', 'y'));
dictSet(dictyellow, 'z3', getObjTransform(dictyellow, false, 'position', 'z'));
dictblue = {};
dictSet(cloneblue, 'x4', getObjTransform(dictblue, false, 'position', 'x'));
dictSet(dictblue, 'y4', getObjTransform(dictblue, false, 'position', 'y'));
dictSet(dictblue, 'z4', getObjTransform(dictblue, false, 'position', 'z'));

handleAnnot(true, 'Help!', 'Plane', 'A user can only use the block of same colour,' + 'if the user wants the block they can get it by double cllicking on the block', 'poi1', undefined);

addHTMLElement('button', 'button1', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('position', 'static', 'button1', false);
...
setHTMLElemStyle('position', 'static', 'button2', false);
